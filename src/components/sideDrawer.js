...
const SideDrawer = (props) => {
  ...
  useEffect(() => {
    if (
      ...
      !Object.keys(currentUserModel.values).length
    ) {
      setUserLoaded(false);
    } else {
      setUserLoaded(true);
                ...
                <>
                  <View style={styles.profilePic}>
                    {currentUserModel.values.image_source ? (
                      <Image
                        ...
                        source={{ uri: currentUserModel.values.image_source }}
                      />
                    ) : (
                  ...
                  <View style={styles.nameContainer}>
                    <Text style={styles.name}>
                      Hello, {currentUserModel.values.name}
                    </Text>
                  </View>
                  <View style={styles.rewardContainer}>
                    <Text style={styles.reward}>
                      ...
                      <Text
                        style={{ fontFamily: "Roboto-Medium", fontSize: 18 }}
                      >
                        {" "}
                        {currentUserModel &&
                          currentUserModel.values &&
                          currentUserModel.values.user_meta &&
                          currentUserModel.values.user_meta.reward_points}
                      </Text>
                    </Text>
                  </View>
                </>
