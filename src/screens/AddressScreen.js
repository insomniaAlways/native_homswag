          ...
          <View style={{ flex: 1 }}>
            {addressModel.isLoading ? (
              ...
              <View style={{ flex: 1 }}>
                ...
                >
                  <TouchableOpacity
                    style={[styles.button, DefaultStyles.brandColorButton]}
                    onPress={() =>
                      navigation.navigate("AddNewAddress", {
                        previousRoute: "Address"
                      })
                    }
                  >
                    <Text
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    setDefault: (address_id, is_default) =>
      dispatch(updateAddress(address_id, is_default))
  };
};
