...
function ScheduleAppointmentScreen(props) {
            ...
            if (isAfter) {
              if (
                moment().isSameOrAfter(
                  moment().startOf('days').add(18, 'hours')
                )
              ) {
                ...
                ShowAlert(
                  'Oops!',
                  'You cannot schedule for the selected time slot.'
                );
              }
              return false;
            } else {
  ...
  return (
    <KeyboardAvoidingView
        ...
        <View
          ...
          <View
            ...
            <Text
              ...
              Please note your booking slot is pending with us, Our support Team
              will confirm you within an hour time with details.Thank you for
              choosing Homswag.
            </Text>
          </View>
        </View>
      ...
      <View
        style={[
          { height: 55, marginBottom: insets.bottom, justifyContent: 'center' },
          DefaultStyles.brandBackgroundColor
        ]}>
        <TouchableOpacity
          onPress={() => save()}
          style={{
          ...
          <View style={styles.scrollableModal}>
            <View style={styles.addressListHeader}>
              ...
              <TouchableOpacity onPress={() => goToAddAddress()}>
                <Text style={[{ width: 50 }, styles.addressListHeaderText]}>
                  + Add
                </Text>
              </TouchableOpacity>
            </View>
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    updateAppointment: (appointment) =>
      dispatch(updateAppointmentState(appointment)),
